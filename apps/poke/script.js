...
function checkAnswer() {
    ...
    if (!isGuessChecked) {
        ...
        // Default case
            ...
            if (currentPokemon.name === "Flapple" && currentPokemon.form === "Gigantamax" && nameGuess.toLowerCase() === "appletun") {
                nameMatch = true;
            }
